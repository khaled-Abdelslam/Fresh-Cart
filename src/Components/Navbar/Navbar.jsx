      ...
      <nav className="bg-gray-100 border-gray-200 dark:bg-gray-900 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex gap-3">
            ...
            <div className="hidden w-full md:block md:w-auto " id="navbar-default">
              {userLogin !== null ? <ul className="font-medium flex flex-col h-[100%] items-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-100 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-gray-100    dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                  <NavLink to="cart" className="block py-2 px-3  text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"><div className="flex">Cart <div className="bg-green-600 rounded ms-2 ">{numberOfCartItems}</div></div></NavLink>
                </li>
                <li>
          ...
          <div className="flex items-center gap-3 ">
            ...
            <ul className='font-medium   dark:text-white  flex flex-col py-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-100 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-gray-100  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700'>
              {userLogin == null ? <> <li>
